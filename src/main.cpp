...
const string strMessageMagic = "Ripped Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Ripped", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "newripped 2018 hibrida";
        CTransaction txNew;
        txNew.nTime = 1523412038;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1523412038;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1141895 : 1141895;
        ...
        assert(block.hashMerkleRoot == uint256("0xe7aa5cb4c5fbc0034c53ee87f3850d34b1c12058499605605aac41045c07e09e"));
...
unsigned char pchMessageStart[4] = { 0x91, 0x94, 0xa6, 0x07 };
