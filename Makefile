#############################################################################
# Makefile for building: ripped-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Wed Apr 11 04:17:07 2018
# Project:  Ripped-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake RELEASE=1 -o Makefile Ripped-qt.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -Wl,-Bstatic -lminiupnpc /tmp/Ripped/src/leveldb/libleveldb.a /tmp/Ripped/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -Wl,-Bdynamic -lrt -ldl -lpthread -lQtGui -lQtCore 
AR            = ar cqs
RANLIB        = 
...
Makefile: Ripped-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) RELEASE=1 -o Makefile Ripped-qt.pro
...
/tmp/Ripped/src/leveldb/libleveldb.a: FORCE
	cd /tmp/Ripped/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/tmp/Ripped/build/build.h: FORCE
	cd /tmp/Ripped; /bin/sh share/genbuild.sh /tmp/Ripped/build/build.h
